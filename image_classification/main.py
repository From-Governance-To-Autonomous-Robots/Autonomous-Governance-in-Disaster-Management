...
def main():
    ...
    combined_df = combine_tsv_files(Config.DATASET_DIR_PATH, Config.TSV_FILES, Config.COMBINED_DATA_PATH, Config.DROPPED_COLUMNS)
    split_data(combined_df, Config.TRAIN_DATA_PATH, Config.VAL_DATA_PATH, Config.IMAGE_TARGET_COLUMN)
    
    # Perform data analysis
    perform_data_analysis(Config.TRAIN_DATA_PATH, Config.LOG_DIR, label_columns=[Config.IMAGE_TARGET_COLUMN])
    perform_data_analysis(Config.VAL_DATA_PATH, Config.LOG_DIR, label_columns=[Config.IMAGE_TARGET_COLUMN])
